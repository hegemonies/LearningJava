...
public class PhoneBook {
    private ArrayList<LegalEntity> entities = new ArrayList<>();
    ...
    public void AddLegalEntity(String Name, String phone, int TIN, String address, int CRR, int capital) {
        entities.add(new LegalEntity(Name, phone, TIN, address, CRR, capital));
    }
    ...
    public void DeleteLegalEntity(String Name) {
    ...
    public void ShowLegalEntitys() {
        log.info("List of LegalEntity's");
    ...
    public void PhoneBookToFile(String fileName) {
        ...
        try (FileWriter writer = new FileWriter(fileName, false)) {
            ...
            for (LegalEntity entity : entities) {
                writer.write(TypeUser.LegalEntity + "," + entity.toCSV() + "\n");
            }
        } catch (IOException exc) {
    ...
    private void LegalEntitysToFile(String fileName) {
        File file = new File(fileName);
        ...
        if (file.exists()) {
            ...
            try {
                ...
                log.error("Error creating file in LegalEntitysToFile(): " + exc.getMessage());
            }
        }
        ...
        try (FileWriter writer = new FileWriter(fileName, false)) {
            ...
            log.error("Error open file in LegalEntitysToFile(): " + exc.getMessage());
        }
    }
        ...
        try (FileReader reader = new FileReader(fileName)) {
            ...
            for (String row : rows) {
                ...
                try {
                    ...
                    } else if (elems[0].equals("LegalEntity")) {
                        entities.add(new LegalEntity(elems[1],
                                elems[2],
    ...
    public void Backup() {
        ...
        System.out.println("Enter file name for LegalEntity's: ");
        String toLegalEntitys = scanner.next();
        System.out.println("Enter file name for Individuals: ");
        String toIndividuals = scanner.next();

        this.LegalEntitysToFile(toLegalEntitys);
